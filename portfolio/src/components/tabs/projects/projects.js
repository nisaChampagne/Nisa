  ...
  return (
    <div className="projectsContainer">
      ...
      <div className="projects">
        ...
        <div className="centeredBtns">
          <a
            href="https://github.com/nisaChampagne/React-Todo"
            className="projectBtn"
          >
            Github Link{" "}
          </a>
          <a href="https://react-todo-4bm2326a5.now.sh/" className="projectBtn">
            Hosted
          </a>
        </div>
      </div>
      ...
      <div className="projects">
        ...
        {/* <div className="projectList">
          <ul>
            <li>
              <NavLink to="/drum" exact className="navLink_project">
                Drum Kit
              </NavLink>
            </li>
          </ul>
